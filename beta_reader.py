...
def beta_reader(direc):
    ...
    He_emi_beta = np.loadtxt('%s/Beta Values/he_emi_beta_final4.txt' % path)
    He_cyg_beta = np.loadtxt('%s/Beta Values/he_cyg_beta_final4.txt' % path)
    ...
    he_6678_beta = np.loadtxt('%s/Beta Values/he_6678_beta_final2.txt' % path)
